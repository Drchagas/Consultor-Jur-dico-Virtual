...
chcp 65001 >nul
color 0B
title JARBAS Juridico Enterprise 9.0.2 - Instalador Completo
cd /d "%~dp0"
echo.
echo ========================================================================
echo  JARBAS JURIDICO ENTERPRISE 9.0.2 - AUDITED BUILD
echo ========================================================================
echo.
...
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0INSTALAR_JARBAS_9_0_2.ps1"
set RC=%ERRORLEVEL%
echo.
if "%RC%"=="0" (
 color 0A
